...
data(testData)
data(testDataSNE)
allDataRows <- c(1:200, 1001:1200, 10001:10200, 
                 11001:11200)
...
dColorPlot(colorData = testDataSubset$ids, xYData = testDataSNESubset, 
           createOutput = FALSE)
...
DepecheR:::dPlotCoFunction(colorVariable = testColor, plotName = "test", 
...
# Alternative usage
dDensityPlot(xYData = testDataSNESubset, idsVector = testDataSubset$ids, 
             plotDir = ".", createOutput = FALSE)

###################### dDensityPlotCoFunction
DepecheR:::dDensityPlotCoFunction(xYData = xYData, color="blue", 
