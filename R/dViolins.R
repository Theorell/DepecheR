...
dViolins <- function(clusterVector, inDataFrame, 
    ...
    allClusterCols <- dColorVector(plotClusters, colorOrder = colorOrder, 
    ...
    lapply(seq_along(plotClusters), function(x) dViolinsCoFunction(
        clusterNum = plotClusters[x], 
        plotElement = plotElements[[plotClusters[x]]], 
