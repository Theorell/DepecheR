...
#' @param color This gives the specific color of the plot. It has four potential return values. Either it is a specific color ("red" or "#FF0000"), it is "rainbowCols", which creates a specific set of colors similar to the rainbow. The third alternative is "idSpecific", which will then give each plot a different color depending on their id. The fourth alternative is that a vector of colors (e.g. either "red" or "#FF0000") with the same length as the number of rows in xYData is provided. Here, a separate density estimate will be performed for each color subcompartment of the xYData and these will be plotted together.
